...
public class QuaternionAssert {
     ...
     */
    public static void assertEquals(Quaternionfc expected, Quaternionfc actual) {
     ...
     */
    public static void assertEquals(Quaternionfc expected, Quaternionfc actual, String message) {
     ...
     */
    public static void assertIdentity(Quaternionfc actual) {
     ...
     */
    public static void assertIdentity(Quaternionfc actual, float epsilon) {
        Quaternionfc identity = new Quaternionf(0, 0, 0, 1);
     ...
     */
    public static void assertAngleEquals(Quaternionfc expected, Quaternionfc actual, float maxAngleRadians) {
     ...
     */
    public static void assertRotationY(Quaternionfc actual, float expectedAngleDegrees) {
     ...
     * Asserts that a quaternion represents a specific rotation angle around Y axis.
     */
    public static void assertRotationY(Quaternionfc actual, float expectedAngleDegrees, float epsilon) {
        Quaternionfc expected = new Quaternionf().rotateY((float) Math.toRadians(expectedAngleDegrees));
